function results = ...
    continuous_prediction_combined(timeseries,eigenvectors,family,phenotype,...
    pthresh,seeds)
%% builds predictive models for combined standard/caricatured data vs continuous phenotypes
...
for seed_ind = 1:length(seeds)
    ...
    [~,~,~,curr_pred(pred_subj)] = ridgeCPM(mats_combined(:,pred_subj),phenotype,...
