function results = ...
    binary_prediction_subsample(timeseries,eigenvectors,subsample_inds,...
...
for seed_ind = 1:n_iter
    ...
    curr_results = binary_prediction(curr_timeseries,curr_eigenvectors,...
