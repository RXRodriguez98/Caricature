function results = ...
    continuous_prediction_subsample_nulls(timeseries,eigenvectors,subsample_inds,...
...
%% calls continuous_prediction_nulls.m
...
for seed_ind = 1:n_iter
    ...
    curr_results = continuous_prediction_nulls(curr_timeseries,curr_eigenvectors,...
