function results = ...
    continuous_prediction_subsample(timeseries,eigenvectors,subsample_inds,...
...
%% Iterate through seeds and call continuous_prediction
for seed_ind = 1:n_iter
    ...
    curr_results = continuous_prediction(curr_timeseries,curr_eigenvectors,...
